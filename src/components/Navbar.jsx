...
const Navbar=()=>{
    return(
        ...
        <p className="bg-black py-1 px-3 rounded-2xl text-[2xl] cursor-pointer">Install App</p>
        <p className="bg-purple-500 text-black justify-center items-center rounded-full flex w-7 h-7">D</p>
        </div>
        </div>
        <div className="flex items-center gap-2 mt-4">
        <p className="bg-white text-black py-1 px-4 rounded-2xl cursor-pointer">All</p>
        <p className="bg-black text-white py-1 px-4 rounded-2xl cursor-pointer">Music</p>
        <p className="bg-black text-white py-1 px-4 rounded-2xl cursor-pointer">Podcasts</p>
        </div>
        </>
    )
}
